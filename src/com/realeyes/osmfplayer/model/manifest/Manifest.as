...
package com.realeyes.osmfplayer.model.manifest
{
	...
	{			
		...
		/**
		 * The &lt;clipStart&gt; element represents the the start time in seconds of a clip
		 * so the playlist can specify pieces of video in a playlist
		 */ 
		...
		/**
		 * The set of plugins that should be loaded for each MediaElement 
		 */		
		public var facets:Vector.<KeyValueFacet> = new Vector.<KeyValueFacet>();
	}
}